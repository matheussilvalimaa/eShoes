...
namespace eShoes.Authentication
{
    public class JwtService
    {
        ...
        /// JWT token for a given username, and optionally sets roles, like admin.
        public string GenerateToken(string username, IEnumerable<string> roles)
        {
            _logger.LogInformation($"Generating JWT token for user '{username}', Roles={string.Join(", ", roles)}");

            var tokenHandler = new JwtSecurityTokenHandler();

            // Claim to differentiate admin from user role.
